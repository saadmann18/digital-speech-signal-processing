...
N_s = int(np.round(f_rep/f_s))    # REPLACE N_s = # TODO  step size between samples in x_1_t
N = int(f_s*T_M)                   # REPLACE N = # TODO Number of samples taken in total
